...
namespace FiveNightsAtMrIngles
{
    ...
    public class Animatronic : MonoBehaviour
    {
        ...
        public enum AttackSide { Left, Right, Vent }
        #endregion
        ...
        public bool attackFromLeft = true; // Which door to attack from (legacy)
...
#pragma warning restore CS0067
        ...
        void MoveTo(RoomData newRoom)
        {
            ...
            // Check if entered a hallway or vent adjacent to office
            if (attackSide == AttackSide.Vent && newRoom.roomName == "Vent")
            {
                isInHallway = true;
                hallwayTimer = 0f;
            }
        ...
        void CheckHallwayAttack(float dt)
        {
            ...
            // Check if door/vent is blocked
            bool doorClosed;
            if (attackSide == AttackSide.Vent)
            {
                doorClosed = OfficeController.Instance.ventSystemActive;
            }
            else if (attackSide == AttackSide.Left)
            {
                doorClosed = OfficeController.Instance.doorLeftClosed;
            }
            else
            {
                doorClosed = OfficeController.Instance.doorRightClosed;
            }
